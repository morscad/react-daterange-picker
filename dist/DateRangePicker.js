...
function (_PureComponent) {
  ...
  function DateRangePicker() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onOutsideAction", function (event) {
      var alwaysKeepOpen = _this.props.alwaysKeepOpen;

      if (_this.wrapper && !_this.wrapper.contains(event.target)) {
        if (!alwaysKeepOpen || !!alwaysKeepOpen && alwaysKeepOpen === 'false') _this.closeCalendar();
      }
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "onChangeFrom", function (valueFrom) {
      ...
      var _this$props = _this.props,
          alwaysKeepOpen = _this$props.alwaysKeepOpen,
      ...
      if (!!alwaysKeepOpen && alwaysKeepOpen === 'true') {
        _this.onChange([valueFrom, valueTo]);
      } else {
    ...
    _defineProperty(_assertThisInitialized(_this), "onChangeTo", function (valueTo) {
      ...
      var _this$props2 = _this.props,
          alwaysKeepOpen = _this$props2.alwaysKeepOpen,
  ...
  _createClass(DateRangePicker, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      var _this$props4 = this.props,
          onCalendarClose = _this$props4.onCalendarClose,
          onCalendarOpen = _this$props4.onCalendarOpen;
    ...
    value: function renderInputs() {
      var _this$props5 = this.props,
          calendarIcon = _this$props5.calendarIcon,
          ...
          showLeadingZeros = _this$props5.showLeadingZeros,
    ...
    value: function renderCalendar() {
      ...
      var _this$props6 = this.props,
          calendarClassName = _this$props6.calendarClassName,
          datePickerClassName = _this$props6.className,
          onChange = _this$props6.onChange,
          value = _this$props6.value,
          calendarProps = _objectWithoutProperties(_this$props6, ["calendarClassName", "className", "onChange", "value"]);
...
DateRangePicker.propTypes = _objectSpread({
  alwaysKeepOpen: _propTypes["default"].string
}, _entry["default"].propTypes, {
